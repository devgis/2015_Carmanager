...
{
    public partial class CarTypeList : BaseWindow
    {
        public CarTypeList()
        {
            InitializeComponent();
        ...
        private void InitData()
        {
            ...
            DataTable dt = MySQLHelper.ExecuteQuery("select * from t_cartype").Tables[0];
        ...
        private void cmdDelOperator_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql = string.Format("delete from t_cartype where id in ({0})", args);
