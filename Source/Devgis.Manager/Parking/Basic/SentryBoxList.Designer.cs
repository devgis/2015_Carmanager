namespace Devgis.Manager.Parking.Basic
{
    partial class SentryBoxList
    {
        ...
        private void InitializeComponent()
        {
            ...
            gridViewTextBoxColumn3.HeaderText = "岗亭名称";
            gridViewTextBoxColumn3.MaxWidth = 100;
            gridViewTextBoxColumn3.MinWidth = 100;
            gridViewTextBoxColumn3.Name = "colName";
            gridViewTextBoxColumn3.Width = 100;
            gridViewTextBoxColumn4.HeaderText = "进口信息";
            gridViewTextBoxColumn4.MinWidth = 200;
            gridViewTextBoxColumn4.Name = "colEnterInfo";
            gridViewTextBoxColumn4.Width = 200;
            gridViewTextBoxColumn5.HeaderText = "出口信息";
            gridViewTextBoxColumn5.MinWidth = 200;
            gridViewTextBoxColumn5.Name = "colOutInfo";
            gridViewTextBoxColumn5.Width = 200;
            gridViewTextBoxColumn6.HeaderText = "视频1";
            gridViewTextBoxColumn6.MaxWidth = 600;
            gridViewTextBoxColumn6.MinWidth = 200;
            gridViewTextBoxColumn6.Name = "colVideo1";
            gridViewTextBoxColumn6.Width = 200;
            gridViewTextBoxColumn7.HeaderText = "视频2";
            gridViewTextBoxColumn7.MinWidth = 200;
            gridViewTextBoxColumn7.Name = "colVideo2";
            gridViewTextBoxColumn7.Width = 200;
            gridViewTextBoxColumn8.HeaderText = "视频3";
            gridViewTextBoxColumn8.MinWidth = 200;
            gridViewTextBoxColumn8.Name = "colVideo3";
            gridViewTextBoxColumn8.Width = 200;
            gridViewTextBoxColumn9.HeaderText = "视频4";
            gridViewTextBoxColumn9.MinWidth = 200;
            gridViewTextBoxColumn9.Name = "colVideo4";
