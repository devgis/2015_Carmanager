namespace Devgis.Manager.Parking.Basic
{
    partial class MonthCardList
    {
        ...
        private void InitializeComponent()
        {
            ...
            gridViewTextBoxColumn3.HeaderText = "停车场";
            gridViewTextBoxColumn3.MaxWidth = 100;
            gridViewTextBoxColumn3.MinWidth = 100;
            gridViewTextBoxColumn3.Name = "colParkingName";
            gridViewTextBoxColumn3.Width = 100;
            gridViewTextBoxColumn4.HeaderText = "开始日期";
            gridViewTextBoxColumn4.MinWidth = 100;
            gridViewTextBoxColumn4.Name = "colStartDate";
            gridViewTextBoxColumn4.Width = 103;
            gridViewTextBoxColumn5.HeaderText = "结束日期";
            gridViewTextBoxColumn5.MaxWidth = 100;
            gridViewTextBoxColumn5.MinWidth = 100;
            gridViewTextBoxColumn5.Name = "colEndDate";
            gridViewTextBoxColumn5.Width = 100;
            gridViewTextBoxColumn6.HeaderText = "金额";
            gridViewTextBoxColumn6.MaxWidth = 100;
            gridViewTextBoxColumn6.MinWidth = 150;
            gridViewTextBoxColumn6.Name = "colAmount";
            gridViewTextBoxColumn6.Width = 100;
            gridViewTextBoxColumn7.HeaderText = "使用余额";
            gridViewTextBoxColumn7.MaxWidth = 60;
            gridViewTextBoxColumn7.MinWidth = 60;
            gridViewTextBoxColumn7.Name = "colUseBalance";
            gridViewTextBoxColumn7.Width = 60;
            gridViewTextBoxColumn8.HeaderText = "操作员";
            gridViewTextBoxColumn8.MinWidth = 100;
            gridViewTextBoxColumn8.Name = "colOperator";
